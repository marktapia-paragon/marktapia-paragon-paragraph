...
> {
  ...
  define(
    ...
    const firedStep = new FunctionStep({
      autoRetry: false,
      description: '"Fired!"',
    ...
    triggerStep.nextStep(firedStep);

    /**
     * Pass all steps used in the workflow to the `.register()`
     * function. The keys used in this function must remain stable.
     */
    return this.register({ triggerStep, firedStep });
  }
   ...
   */
  readonly id: string = '86e70c8b-e688-4019-87f3-be7e92471c75';
}
