...
import { InputResultMap } from '@useparagon/integrations/slack';
...
> {
   ...
   */
  readonly id = '7a7ab971-d67b-46cc-9f30-182cb5069a2e';
   ...
   */
  description = 'Trigger from any event supported by Slack';
