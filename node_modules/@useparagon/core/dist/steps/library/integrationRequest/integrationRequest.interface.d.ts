...
export type BaseIntegrationRequestParams = Pick<IIntegrationRequestStepParameters, 'resourceId' | 'actionType' | 'httpMethod' | 'retryOnFailure' | 'ignoreFailure' | 'url' | 'params' | 'headers' | 'paginationOptions'>;
...
export type IIntegrationRequestStepParameters = IRequestStepParameters & {
