...
class RequestStep extends step_1.Step {
    ...
    constructor(params) {
        super(params);
        const { baseUrl, params: mergedParams } = (0, resolver_utils_1.parseUrlParams)(params.url, params.params);
        this._parameters = {
            ...params,
            url: baseUrl,
            params: mergedParams,
    ...
    serializeParameters() {
        ...
        const isRawOrXmlBody = [
            request_interface_1.RequestBodyType.RAW,
            request_interface_1.RequestBodyType.XML,
        ].includes(initParams.bodyType);
        const baseParams = {
        ...
        if (initParams.bodyType === request_interface_1.RequestBodyType.GRAPHQL) {
            return {
                ...baseParams,
                bodyType: request_interface_1.RequestBodyType.GRAPHQL,
                query: (0, resolver_utils_1.resolveToTokenizedSource)(initParams.query || '', resolvers_interface_1.DataType.STRING, this.dependencies),
                variables: initParams.variables
                    ? (0, resolver_utils_1.resolveToTokenizedSource)(initParams.variables, resolvers_interface_1.DataType.STRING, this.dependencies)
                    : undefined,
            };
        }
        return {
            ...
            body: typeof initParams.body === 'string' || isRawOrXmlBody
                ? []
                : (0, resolver_utils_1.resolveParamsToSources)(initParams.body || {}, resolvers_interface_1.DataType.ANY, undefined, this.dependencies),
            rawBody: isRawOrXmlBody
                ? (0, resolver_utils_1.resolveToTokenizedSource)(initParams.body || '', resolvers_interface_1.DataType.ANY, this.dependencies)
                : undefined,
        };
    }
}
