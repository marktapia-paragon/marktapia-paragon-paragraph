...
export type CustomWebhookRequest = {
    headers: Record<string, string>;
...
export type CustomTriggerSetupResponse = {
    ...
    code: (parameters: Record<string, any>, libraries: Pick<FunctionStepLibraries, 'crypto'>, request: CustomWebhookRequest) => SetupResponse;
...
export type TriggerPayloadValidationOption = {
    ...
    parameters: Record<string, any>;
    code: (parameters: Record<string, any>, libraries: Pick<FunctionStepLibraries, 'crypto'>, request: CustomWebhookRequest) => boolean;
} | {
