...
export declare enum ProxyVariableSourceType {
    ...
    BYO_OAUTH_APP_CREDENTIAL = "BYO_OAUTH_APP_CREDENTIAL",
    SAVED_CREDENTIAL_DATA = "SAVED_CREDENTIAL_DATA",
    UUID_NONCE = "UUID_NONCE",
    WORKFLOW_EXECUTION_FIELD = "WORKFLOW_EXECUTION_FIELD"
}
