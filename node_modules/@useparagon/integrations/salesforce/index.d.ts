...
export type ISalesforceIntegration = {
  ...
  actions: {
     ...
     */
    deleteRecord: (
      inputs: IntentToInputOutput['SALESFORCE_DELETE_RECORD'][0],
      options: IntegrationOptions,
    ) => ActionStep<
      IntentToInputOutput['SALESFORCE_DELETE_RECORD'][0],
      IntentToInputOutput['SALESFORCE_DELETE_RECORD'][1]
    >;
     ...
     */
    searchRecordsV2: (
      inputs: IntentToInputOutput['SALESFORCE_SEARCH_RECORDS_V2'][0],
      options: IntegrationOptions,
    ) => ActionStep<
      IntentToInputOutput['SALESFORCE_SEARCH_RECORDS_V2'][0],
      IntentToInputOutput['SALESFORCE_SEARCH_RECORDS_V2'][1]
    >;
     ...
     */
    writeSoqlQueryV2: (
      inputs: IntentToInputOutput['SALESFORCE_WRITE_SOQL_QUERY_V2'][0],
      options: IntegrationOptions,
    ) => ActionStep<
      IntentToInputOutput['SALESFORCE_WRITE_SOQL_QUERY_V2'][0],
      IntentToInputOutput['SALESFORCE_WRITE_SOQL_QUERY_V2'][1]
    >;
