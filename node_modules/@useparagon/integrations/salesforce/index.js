...
/**
 * triggers for salesforce
 */
exports.triggers = [
  {
    title: 'New Record',
    name: 'SALESFORCE_TRIGGER_RECORD_CREATED',
    output: [],
    inputs: [
      {
        id: 'recordType',
  ...
  },
  {
    ...
    name: 'SALESFORCE_TRIGGER_RECORD_DELETED',
    output: [],
    inputs: [
      {
        id: 'recordType',
      ...
      },
      {
        ...
        title: 'Filter search',
        type: 'CONDITIONAL',
        subtitle: 'Only trigger on deleted records that match these filters.',
        supportedKeysSource: {
          sourceType: 'cachedFields',
          dependencies: ['recordType'],
        },
  ...
  },
  {
    ...
    name: 'SALESFORCE_TRIGGER_RECORD_UPDATED',
    output: [],
    inputs: [
      {
        id: 'recordType',
  ...
  },
  {
    ...
    name: 'SALESFORCE_TRIGGER_CAMPAIGN_MEMBER_ADDED',
    output: [],
    inputs: [
      {
        id: 'campaignId',
  ...
  {
    title: 'Campaign Opportunity Added',
    name: 'SALESFORCE_TRIGGER_CAMPAIGN_OPPORTUNITY_ADDED',
    output: [],
    inputs: [
      {
        id: 'campaignId',
...
exports.intents = [
            ...
            dependentInputs: [
              {
                ...
                title: 'Name',
                type: 'TEXTAREA',
                subtitle: 'The Opportunity name. This field is required.',
                required: true,
              },
              {
                id: 'field-StageName',
              ...
              },
              {
                ...
                type: 'TEXTAREA',
                subtitle:
                  'Defaults to 30 days from the current date if not provided.',
              ...
              },
              {
                ...
                type: 'TEXTAREA',
                subtitle:
                  'The Salesforce user assigned to work on this Opportunity.',
              },
              {
                id: 'field-NextStep',
                title: 'Next Step',
            ...
            dependentInputs: [
              {
                ...
                title: 'Account Name',
                type: 'TEXTAREA',
                subtitle: 'The Account name. This field is required.',
                required: true,
              },
              {
                id: 'field-OwnerId',
            ...
            dependentInputs: [
              {
                ...
                type: 'TEXTAREA',
                subtitle:
                  'The ID of the Account or Opportunity this Task is related to.',
              },
              {
                id: 'field-whoId',
                title: 'Name ID',
              ...
              },
              {
                ...
                required: true,
                defaultValue: 'task',
                values: ['task', 'email', 'listEmail', 'call'],
              },
              {
                id: 'field-Status',
                title: 'Status',
            ...
            dependentInputs: [
              {
                ...
                title: 'Record ID',
                type: 'TEXTAREA',
                subtitle: 'The ID of the record to delete.',
                required: true,
              },
            ],
          },
  ...
  },
  {
    ...
    name: 'SALESFORCE_SEARCH_RECORDS_V2',
    output: [],
    inputs: [
      {
        id: 'recordType',
  ...
  {
    title: 'Search records by SOQL query (Legacy)',
    ...
    inputs: [
      {
        ...
        type: 'CODE',
        subtitle:
          'Write a query using Salesforce Object Query Language (SOQL). Supports SOQL SELECT Syntax. (https://developer.salesforce.com/docs/atlas.en-us.soql_sosl.meta/soql_sosl/sforce_api_calls_soql.htm)',
  ...
  {
    title: 'Search records by SOQL query',
    name: 'SALESFORCE_WRITE_SOQL_QUERY_V2',
    output: [],
    inputs: [
      {
        id: 'query',
                    ...
                    dependentInputs: [
                      {
                        ...
                        type: 'TEXTAREA',
                        subtitle:
                          'The maximum length of the text field. Minimum length 256',
                        required: true,
                      },
                      {
                        id: 'visibleLines',
  ...
  {
    title: 'Get records by List View',
    name: 'SALESFORCE_GET_CONTACTS_BY_VIEW_ID',
    output: [],
    inputs: [
      {
        id: 'recordType',
        ...
        required: true,
        values: ['Opportunity', 'Account', 'Contact', 'Lead', 'Task'],
      },
      {
        id: 'listViewId',
        title: 'List View ID',
...
/**
 * integration class for salesforce
 */
exports.integration = {
  /**
   * name of integration
  ...
  actions: {
    ...
    createRecord: (inputs, options) => {
      return new ActionStep({
        intent: 'SALESFORCE_CREATE_RECORD',
    ...
    updateRecord: (inputs, options) => {
      return new ActionStep({
        intent: 'SALESFORCE_UPDATE_RECORD',
        actionType: 'salesforce',
        parameters: inputs,
        description: options.description,
        autoRetry: options.autoRetry,
    ...
    /**
     * Delete record
     * method for SALESFORCE_DELETE_RECORD
     */
    deleteRecord: (inputs, options) => {
      return new ActionStep({
        intent: 'SALESFORCE_DELETE_RECORD',
        actionType: 'salesforce',
        parameters: inputs,
        description: options.description,
        autoRetry: options.autoRetry,
    ...
    getRecordById: (inputs, options) => {
      return new ActionStep({
        intent: 'SALESFORCE_GET_RECORD_BY_ID',
        actionType: 'salesforce',
        parameters: inputs,
        description: options.description,
        autoRetry: options.autoRetry,
    ...
    searchRecords: (inputs, options) => {
      return new ActionStep({
        intent: 'SALESFORCE_SEARCH_RECORDS',
        actionType: 'salesforce',
        parameters: inputs,
        description: options.description,
        autoRetry: options.autoRetry,
    ...
    /**
     * Search records
     * method for SALESFORCE_SEARCH_RECORDS_V2
     */
    searchRecordsV2: (inputs, options) => {
      return new ActionStep({
        intent: 'SALESFORCE_SEARCH_RECORDS_V2',
        actionType: 'salesforce',
        parameters: inputs,
        description: options.description,
        autoRetry: options.autoRetry,
    ...
    /**
     * Search records by SOQL query (Legacy)
     * method for SALESFORCE_WRITE_SOQL_QUERY
     */
    writeSoqlQuery: (inputs, options) => {
      return new ActionStep({
        intent: 'SALESFORCE_WRITE_SOQL_QUERY',
        actionType: 'salesforce',
        parameters: inputs,
        description: options.description,
        autoRetry: options.autoRetry,
     ...
     * method for SALESFORCE_WRITE_SOQL_QUERY_V2
     */
    writeSoqlQueryV2: (inputs, options) => {
      return new ActionStep({
        intent: 'SALESFORCE_WRITE_SOQL_QUERY_V2',
        actionType: 'salesforce',
        parameters: inputs,
        description: options.description,
        autoRetry: options.autoRetry,
     ...
     */
    createCustomField: (inputs, options) => {
      return new ActionStep({
        intent: 'SALESFORCE_CREATE_CUSTOM_FIELD',
        actionType: 'salesforce',
        parameters: inputs,
        description: options.description,
        autoRetry: options.autoRetry,
    ...
    createCustomObject: (inputs, options) => {
      return new ActionStep({
        intent: 'SALESFORCE_CREATE_CUSTOM_OBJECT',
        actionType: 'salesforce',
        parameters: inputs,
        description: options.description,
        autoRetry: options.autoRetry,
     ...
     */
    getContactsByViewId: (inputs, options) => {
      return new ActionStep({
        intent: 'SALESFORCE_GET_CONTACTS_BY_VIEW_ID',
        actionType: 'salesforce',
        parameters: inputs,
        description: options.description,
        autoRetry: options.autoRetry,
  ...
  triggers: {
    ...
    recordCreated: (inputs) => {
      return new ActionTriggerStep({
        intent: 'SALESFORCE_TRIGGER_RECORD_CREATED',
        actionType: 'salesforce',
        parameters: inputs,
      });
    },
    ...
    recordDeleted: (inputs) => {
      return new ActionTriggerStep({
        intent: 'SALESFORCE_TRIGGER_RECORD_DELETED',
        actionType: 'salesforce',
        parameters: inputs,
      });
    },
    ...
    recordUpdated: (inputs) => {
      return new ActionTriggerStep({
        intent: 'SALESFORCE_TRIGGER_RECORD_UPDATED',
        actionType: 'salesforce',
        parameters: inputs,
      });
    },
     ...
     */
    campaignMemberAdded: (inputs) => {
      return new ActionTriggerStep({
        intent: 'SALESFORCE_TRIGGER_CAMPAIGN_MEMBER_ADDED',
        actionType: 'salesforce',
        parameters: inputs,
      });
    },
     ...
     */
    campaignOpportunityAdded: (inputs) => {
      return new ActionTriggerStep({
        intent: 'SALESFORCE_TRIGGER_CAMPAIGN_OPPORTUNITY_ADDED',
        actionType: 'salesforce',
        parameters: inputs,
      });
    },
