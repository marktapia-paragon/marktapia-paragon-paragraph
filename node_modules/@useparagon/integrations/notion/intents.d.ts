...
/**
 * Get Page’s Details intent type
 */
...
/**
 * Get a Page’s Contents intent type
 */
...
/**
 * Create a Comment intent type
 */
type NotionCreateComment = {
  /**
   * Page ID
...
/**
 * Update a Comment intent type
 */
type NotionUpdateComment = {
  /**
   * Comment ID
   ...
   * **Example**:
   * ```
   * ce18f8c6-ef2a-427f-b416-43531fc7c117
   * ```
   */
  commentId: string;
   ...
   * **Example**:
   * ```
   * Updated comment with **bold** text.
   * ```
   */
  markdown?: string;
};
...
/**
 * Delete a Comment intent type
 */
type NotionDeleteComment = {
  /**
   * Comment ID
...
/**
 * List Comments intent type
 */
type NotionListComments = {
  /**
   * Block ID
...
export type IntentToInputOutput = {
   ...
   */
  NOTION_CREATE_COMMENT: [NotionCreateComment, any];

  /**
   * NOTION_UPDATE_COMMENT
   */
  NOTION_UPDATE_COMMENT: [NotionUpdateComment, any];

  /**
   * NOTION_DELETE_COMMENT
   */
  NOTION_DELETE_COMMENT: [NotionDeleteComment, any];

  /**
   * NOTION_LIST_COMMENTS
   */
  NOTION_LIST_COMMENTS: [NotionListComments, any];
};
