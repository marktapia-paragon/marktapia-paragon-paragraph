...
export type INotionIntegration = {
  ...
  actions: {
     ...
     */
    createComment: (
      inputs: IntentToInputOutput['NOTION_CREATE_COMMENT'][0],
      options: IntegrationOptions,
    ) => ActionStep<
      IntentToInputOutput['NOTION_CREATE_COMMENT'][0],
      IntentToInputOutput['NOTION_CREATE_COMMENT'][1]
    >;
     ...
     */
    updateComment: (
      inputs: IntentToInputOutput['NOTION_UPDATE_COMMENT'][0],
      options: IntegrationOptions,
    ) => ActionStep<
      IntentToInputOutput['NOTION_UPDATE_COMMENT'][0],
      IntentToInputOutput['NOTION_UPDATE_COMMENT'][1]
    >;
     ...
     */
    deleteComment: (
      inputs: IntentToInputOutput['NOTION_DELETE_COMMENT'][0],
      options: IntegrationOptions,
    ) => ActionStep<
      IntentToInputOutput['NOTION_DELETE_COMMENT'][0],
      IntentToInputOutput['NOTION_DELETE_COMMENT'][1]
    >;
     ...
     */
    listComments: (
      inputs: IntentToInputOutput['NOTION_LIST_COMMENTS'][0],
      options: IntegrationOptions,
    ) => ActionStep<
      IntentToInputOutput['NOTION_LIST_COMMENTS'][0],
      IntentToInputOutput['NOTION_LIST_COMMENTS'][1]
    >;
  };
