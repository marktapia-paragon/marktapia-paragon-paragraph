 ...
 */
type SharepointSaveFile = {
  /**
   * File
   * Accepts a File Object containing file data.
   *
   * **Example**:
   * ```
   * choose a file
...
type SharepointCreateListColumn = {
  ...
  | {
      /**
       * Data Type
       * Determines what type of data the column stores
       *
       */
      dataType: 'choice' | (string & {});
...
export type IntentToInputOutput = {
   ...
   */
  SHAREPOINT_SAVE_FILE: [SharepointSaveFile, any];
