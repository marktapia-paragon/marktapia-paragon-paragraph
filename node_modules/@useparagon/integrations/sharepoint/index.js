    ...
    inputs: [
      {
        id: 'file',
        title: 'File',
        subtitle: 'Accepts a File Object containing file data.',
        type: 'TEXTAREA',
      ...
      },
      {
        ...
        type: 'TEXTAREA',
        subtitle:
          'Use Connect Portal Workflow Settings to allow users to select which Folder to save files to. Defaults to the site root folder if left blank.',
          ...
          'boolean',
          {
            ...
            dependentInputs: [
              ...
              },
              {
                ...
                values: ['checkBoxes', 'dropDownMenu', 'radioButtons'],
              },
            ],
          },
          {
...
exports.integration = {
  ...
  actions: {
    /**
     * Upload File
     * method for SHAREPOINT_SAVE_FILE
     */
    saveFile: (inputs, options) => {
      return new ActionStep({
        intent: 'SHAREPOINT_SAVE_FILE',
