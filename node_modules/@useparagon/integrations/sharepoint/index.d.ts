...
export type ISharepointIntegration = {
  ...
  actions: {
     ...
     */
    saveFile: (
      inputs: IntentToInputOutput['SHAREPOINT_SAVE_FILE'][0],
      options: IntegrationOptions,
    ) => ActionStep<
      IntentToInputOutput['SHAREPOINT_SAVE_FILE'][0],
      IntentToInputOutput['SHAREPOINT_SAVE_FILE'][1]
    >;
