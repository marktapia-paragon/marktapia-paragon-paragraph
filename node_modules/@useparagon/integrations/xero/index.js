...
exports.triggers = [
  ...
  },
  {
    ...
    name: 'XERO_TRIGGER_CUSTOMER_UPDATED',
    output: [],
    inputs: [],
  },
  {
  ...
  },
  {
    ...
    name: 'XERO_TRIGGER_INVOICE_UPDATED',
    output: [],
    inputs: [],
  },
];
  ...
  },
  {
    ...
    inputs: [
      ...
      },
      {
        ...
        type: 'CODE',
        subtitle:
          'Specify optional payment fields as JSON, such as Date, Reference, or a CreditNote identifier.',
        placeholder:
    ...
    inputs: [
      {
        ...
        title: 'Payment ID',
        type: 'TEXTAREA',
        subtitle: 'The ID of the payment to delete.',
        required: true,
      },
    ],
  },
...
exports.integration = {
  ...
  actions: {
     ...
     */
    deletePayment: (inputs, options) => {
      return new ActionStep({
        intent: 'XERO_DELETE_PAYMENT',
        actionType: 'xero',
        parameters: inputs,
        description: options.description,
        autoRetry: options.autoRetry,
  ...
  triggers: {
    ...
    customerUpdated: (inputs) => {
      return new ActionTriggerStep({
        intent: 'XERO_TRIGGER_CUSTOMER_UPDATED',
        actionType: 'xero',
        parameters: inputs,
      });
    },
    ...
    invoiceUpdated: (inputs) => {
      return new ActionTriggerStep({
        intent: 'XERO_TRIGGER_INVOICE_UPDATED',
        actionType: 'xero',
        parameters: inputs,
      });
    },
