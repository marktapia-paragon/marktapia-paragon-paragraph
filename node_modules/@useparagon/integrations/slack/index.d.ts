...
export type ISlackIntegration = {
  ...
  actions: {
    ...
    /**
     * List Channels
     * method for SLACK_LIST_CHANNELS
     */
    listChannels: (
      inputs: IntentToInputOutput['SLACK_LIST_CHANNELS'][0],
      options: IntegrationOptions,
    ) => ActionStep<
      IntentToInputOutput['SLACK_LIST_CHANNELS'][0],
      IntentToInputOutput['SLACK_LIST_CHANNELS'][1]
    >;

    /**
     * List Members
     * method for SLACK_LIST_MEMBERS
     */
    listMembers: (
      inputs: IntentToInputOutput['SLACK_LIST_MEMBERS'][0],
      options: IntegrationOptions,
    ) => ActionStep<
      IntentToInputOutput['SLACK_LIST_MEMBERS'][0],
      IntentToInputOutput['SLACK_LIST_MEMBERS'][1]
    >;
  };
