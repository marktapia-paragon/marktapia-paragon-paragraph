...
exports.intents = [
  {
    ...
    inputs: [
      ...
      },
      {
        ...
        type: 'CODE',
        subtitle:
          'Use the Slack Block Kit Builder (https://app.slack.com/block-kit-builder) to design your message and copy the Payload here.',
        placeholder:
...
exports.integration = {
  ...
  actions: {
     ...
     */
    listMembers: (inputs, options) => {
      return new ActionStep({
        intent: 'SLACK_LIST_MEMBERS',
        actionType: 'slack',
        parameters: inputs,
        description: options.description,
        autoRetry: options.autoRetry,
